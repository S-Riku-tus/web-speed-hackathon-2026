...
import { FetchHttpError, sendJSON } from "@web-speed-hackathon-2026/client/src/utils/fetchers";
...
function getErrorCode(err: unknown, type: "signin" | "signup"): string {
  const responseJSON = err instanceof FetchHttpError ? err.responseJSON : undefined;
  if (
